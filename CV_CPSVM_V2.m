%% Cross Validation for CPSVM model, version 2 (linear kernel)
...
save('CPSVM_v2_CV_results_with_epsi.mat', 'Out_results');

disp('Results saved to CPSVM_v2_CV_results_with_epsi.mat');
